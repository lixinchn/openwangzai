import OpenWangZaiConfig from '../model';
...
export default class SettingManager {
    ...
    static findUtterancesUsingApplicationId(strApplicationId) {
        // TODO: find from DB
        if (strApplicationId === 'test') {
